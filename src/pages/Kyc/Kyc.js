                            ...
                            <div className="w-full mx-auto rounded-sm border-gray-200">
                                ...
                                <div className="text-sm font-medium bg-white text-center text-gray-500 dark:bg-gray-600 dark:text-gray-100 transition-all duration-500 ease-in-out">
                                    <ul className="flex flex-wrap -mb-px">
                                        <li className="mr-2">
                                            <Link to='' className="inline-block p-4 border-b-2 border-[#5db1b5] active">To Be Reviewed</Link>
                                        </li>
                                        <li className="mr-2">
                                            <Link to='' className="inline-block p-4 border-transparent" aria-current="page">View All</Link>
                                        </li>
                                        <li className="mr-2">
                                            <Link to='' className="inline-block p-4 border-transparent" aria-current="page">Passed</Link>
                                        </li>
                                        <li className="mr-2">
                                            <Link to='' className="inline-block p-4 border-transparent" aria-current="page">Failed</Link>
                                        </li>
                                    </ul>
                                </div>
