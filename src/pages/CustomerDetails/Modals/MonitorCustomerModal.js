    ...
    return (<>
            <div className='modal-content'>
                <div className="pb-3 switcher">
                    <p className="text-gray-400 dark:text-gray-100 font-bold">Monitor Account</p>
            ...
            <div className='modal-buttons'>
                ...
                <div className='modal-button'>
                    <button onClick={() => saveMonitorCustomerStatus(monitorCustomerStatus, reason)}
                            className='bg-[#52b2b6] hover:opacity-80 text-white text-xs text-center font-bold py-3 px-4 rounded w-full mb-2'>Confirm
                    </button>
                </div>
            </div>
        </>
...
MonitorCustomerModal.propTypes = {}

MonitorCustomerModal.defaultProps = {}

export default MonitorCustomerModal
